            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <main>
                        ...
                        <form method="post" action="<c:url value="submitWithdrawal.ez"/>">
                            <div class="col-md-8"><!--col-xs-2col-sm-6-->
                               <div class="form-group">
                                    <label for="accountsWithdrawal">Choose Account: </label> &nbsp;
                                    <select id="accountsWithdrawal" name="accountsWithdrawal">
